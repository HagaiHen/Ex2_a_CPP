...
int main() {
	...
	notebook.write(/*page=*/100, /*row=*/100, /*column=*/50, ariel::Direction::Horizontal, "abcd");
	cout << notebook.read(/*page=*/100, /*row=*/99, /*column=*/51, ariel::Direction::Vertical, /*length=*/3) << endl;  
		// prints "_b_" (starts at row 99 which is empty; then at row 100 there is "b"; then row 101 is empty again).
	notebook.write(/*page=*/100, /*row=*/99, /*column=*/52, ariel::Direction::Vertical, "xyz");
		// throws error because writing the letter y will intersect with the letter c
	notebook.erase(/*page=*/100, /*row=*/99, /*column=*/51, ariel::Direction::Vertical, /*length=*/3);
